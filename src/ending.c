...
void ShowEnding()
{
	...
	if (streamspr == NULL) {
		streamspr = IMG_Load("ux0:data/meritous/dat/i/stream.png");
		SDL_SetColorKey(streamspr, SDL_SRCCOLORKEY | SDL_RLEACCEL, 0);
		glitter = IMG_Load("ux0:data/meritous/dat/i/glitter.png");
	...
	Paint(0, 0, 22, 27, "ux0:data/meritous/dat/d/cstream.loc");
...
void DrawCredits()
{
	...
	if (fin == NULL) {
		fin = IMG_Load("ux0:data/meritous/dat/i/fin.png");
		
		theend[0] = IMG_Load("ux0:data/meritous/dat/i/theend.png");
		theend[1] = IMG_Load("ux0:data/meritous/dat/i/true_end.png");
	}
...
void DrawCircuitFlash(int t, int method)
{
	...
	if (circ == NULL) {
		circ = IMG_Load("ux0:data/meritous/dat/i/circuits_1.png");
	}
