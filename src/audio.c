...
char *tracks[13] = {"ux0:data/meritous/dat/m/ICEFRONT.S3M",
					"ux0:data/meritous/dat/m/cavern.xm",
					"ux0:data/meritous/dat/m/cave.xm",
					"ux0:data/meritous/dat/m/cave06.s3m",
					"ux0:data/meritous/dat/m/Wood.s3m",
					"ux0:data/meritous/dat/m/iller_knarkloader_final.xm",
					"ux0:data/meritous/dat/m/fear2.mod",
					"ux0:data/meritous/dat/m/Cv_boss.mod",
					"ux0:data/meritous/dat/m/Fr_boss.mod",
					"ux0:data/meritous/dat/m/CT_BOSS.MOD",
					"ux0:data/meritous/dat/m/rpg_bat1.xm",
					"ux0:data/meritous/dat/m/amblight.xm",
					"ux0:data/meritous/dat/m/FINALBAT.s3m"};
...
void CircuitHum()
{
	...
	if (magic_circuit > 0) {
		...
		if (hum_play != 1) {
			...
			c_sample[0] = Mix_LoadWAV("ux0:data/meritous/dat/a/circuitcharge.wav");
	...
	if (magic_circuit < 0) {
		...
		if (hum_play != 2) {
			...
			c_sample[0] = Mix_LoadWAV("ux0:data/meritous/dat/a/circuitrecover.wav");
			Mix_PlayChannel(0, c_sample[0], -1);
			hum_play = 2;
		}
	}
...
{
	SND_Play("ux0:data/meritous/dat/a/circuitrelease.wav", sqrt(str * 2 + (str * 5300 / circuit_size) + (str > 100 ? 5300 : str*53)));
}
